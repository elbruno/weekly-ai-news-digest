...
| Page | Purpose |
| --- | --- |
| [Claude Sonnet 4.6 AI & Developer News Digest](https://elbruno.github.io/weekly-ai-news-digest/) | Current digest generated by `claude-sonnet-4.6` |
...
The publisher serializes merges, AI Credit reconciliation, and deployment. The Claude Sonnet usage dashboard retains its original URL and reporting behavior. The [comparison dashboard](https://elbruno.github.io/weekly-ai-news-digest/model-comparison.html) pairs runs by snapshot ID to show cost, savings, publication status, and experiment completeness without using AI.
